"""consolidated currency update final

Revision ID: consolidated_currency_update_final
...
revision = 'consolidated_currency_update_final'
...
def upgrade():
    ...
    # New rates: 1 groot = 1000 dabbers, 1 petalin = 100 groots, 1 floren = 10 petalins
    session.execute("""
